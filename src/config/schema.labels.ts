...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "session.relayRouting.rules[].match.chatIdPattern": "Session Relay Rule Chat ID Pattern",
  "session.relayRouting.rules[].match.senderPattern": "Session Relay Rule Sender Pattern",
