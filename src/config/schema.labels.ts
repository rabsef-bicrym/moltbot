...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "session.relayRouting": "Session Relay Routing",
  "session.relayRouting.defaultMode": "Session Relay Default Mode",
  "session.relayRouting.targets": "Session Relay Targets",
  "session.relayRouting.targets.*.channel": "Session Relay Target Channel",
  "session.relayRouting.targets.*.to": "Session Relay Target Destination",
  "session.relayRouting.targets.*.accountId": "Session Relay Target Account ID",
  "session.relayRouting.rules": "Session Relay Rules",
  "session.relayRouting.rules[].mode": "Session Relay Rule Mode",
  "session.relayRouting.rules[].relayTo": "Session Relay Rule Target Key",
  "session.relayRouting.rules[].match": "Session Relay Rule Match",
  "session.relayRouting.rules[].match.channel": "Session Relay Rule Channel Match",
  "session.relayRouting.rules[].match.accountId": "Session Relay Rule Account ID Match",
  "session.relayRouting.rules[].match.chatId": "Session Relay Rule Chat ID Match",
  "session.relayRouting.rules[].match.sender": "Session Relay Rule Sender Match",
